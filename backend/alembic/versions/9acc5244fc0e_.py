...
Revision ID: 9acc5244fc0e
Revises: 9942cf496227
Create Date: 2025-01-19 17:33:31.902736
...
revision: str = '9acc5244fc0e'
down_revision: Union[str, None] = '9942cf496227'
...
def downgrade() -> None:
    ...
    sa.Column('action_type', sa.BOOLEAN(), autoincrement=False, nullable=True),
    sa.Column('created_at', postgresql.TIMESTAMP(), autoincrement=False, nullable=True),
    sa.ForeignKeyConstraint(['community_id'], ['communities.id'], name='community_likes_community_id_fkey', ondelete='CASCADE'),
    sa.ForeignKeyConstraint(['user_id'], ['users.id'], name='community_likes_user_id_fkey', ondelete='CASCADE'),
    sa.PrimaryKeyConstraint('id', name='community_likes_pkey')
    )
