"""I added community like method

Revision ID: d8283d649aa0
Revises: b43cf1fe1dce
Create Date: 2025-01-12 23:41:49.132658
...
revision: str = "d8283d649aa0"
down_revision: Union[str, None] = "b43cf1fe1dce"
...
def downgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "file_name", sa.VARCHAR(length=40), autoincrement=False, nullable=False
        ),
        sa.Column(
            "file_url", sa.VARCHAR(length=150), autoincrement=False, nullable=False
        ),
        sa.Column(
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["channel_id"],
            ["channels.id"],
            name="subscriptions_channel_id_fkey",
            ondelete="CASCADE",
        ),
        sa.ForeignKeyConstraint(
            ["user_id"],
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["comment_id"],
            ["comments.id"],
            name="comments_like_comment_id_fkey",
            ondelete="CASCADE",
        ),
        sa.ForeignKeyConstraint(
            ["user_id"],
            ["users.id"],
            name="comments_like_user_id_fkey",
            ondelete="CASCADE",
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "password", sa.VARCHAR(length=400), autoincrement=False, nullable=False
        ),
        sa.Column(
    ...
    op.create_table(
        ...
        sa.Column(
            "unique_id", sa.VARCHAR(length=50), autoincrement=False, nullable=False
        ),
        sa.Column("title", sa.VARCHAR(length=80), autoincrement=False, nullable=False),
        sa.Column(
            "video_type", sa.VARCHAR(length=20), autoincrement=False, nullable=False
        ),
        sa.Column("user_id", sa.INTEGER(), autoincrement=False, nullable=False),
        ...
        sa.Column(
            "thumbnail_name", sa.VARCHAR(length=40), autoincrement=False, nullable=True
        ),
        sa.Column(
            "thumbnail_url", sa.VARCHAR(length=150), autoincrement=False, nullable=True
        ),
        ...
        sa.Column(
            "schedule_time", postgresql.TIMESTAMP(), autoincrement=False, nullable=True
        ),
        sa.Column(
            "created_at", postgresql.TIMESTAMP(), autoincrement=False, nullable=True
        ),
        sa.ForeignKeyConstraint(
            ["user_id"], ["users.id"], name="videos_user_id_fkey", ondelete="CASCADE"
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "banner_img_url", sa.VARCHAR(length=200), autoincrement=False, nullable=True
        ),
        sa.Column(
            "profile_picture_url",
        ...
        sa.Column(
            "contact_email", sa.VARCHAR(length=100), autoincrement=False, nullable=True
        ),
        sa.ForeignKeyConstraint(
            ["owner_id"],
            ["users.id"],
            name="channels_owner_id_fkey",
            ondelete="CASCADE",
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "visibility", sa.VARCHAR(length=10), autoincrement=False, nullable=True
        ),
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["playlist_id"],
            ["playlists.id"],
            name="playlist_video_playlist_id_fkey",
            ondelete="CASCADE",
        ),
        sa.ForeignKeyConstraint(
            ["video_id"],
            ["videos.unique_id"],
            name="playlist_video_video_id_fkey",
            ondelete="CASCADE",
        ),
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["user_id"],
            ["users.id"],
            name="user_log_info_user_id_fkey",
            ondelete="CASCADE",
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "channel_name", sa.VARCHAR(length=100), autoincrement=False, nullable=True
        ),
        ...
        sa.ForeignKeyConstraint(
            ["video_id"],
            ["videos.unique_id"],
            name="notifications_video_id_fkey",
            ondelete="CASCADE",
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "image_name", sa.VARCHAR(length=200), autoincrement=False, nullable=True
        ),
        sa.Column(
            "image_url", sa.VARCHAR(length=400), autoincrement=False, nullable=True
        ),
        sa.ForeignKeyConstraint(
            ["user_id"],
            ["users.id"],
            name="communities_user_id_fkey",
            ondelete="CASCADE",
        ),
