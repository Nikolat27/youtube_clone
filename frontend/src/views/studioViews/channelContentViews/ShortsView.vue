...
for (let i = 1; i <= 3; i++) {
    shorts.push({ id: i, title: `${i} Short video title`, description: `${i} Short video description` })
}
...
<template>
    <div class="border-b font-roboto pl-[48px] w-full">
        <div v-for="short in shorts" :key="short.id" class="table-itself border-b">
            ...
            <div class="video-detail relative flex flex-col font-normal text-[13px] mt-2" style="padding-left: 12px;">
             ...
             justify-center">
                    ...
                    <button @click="toggleVideoOptions(short.id)" class="w-[39.2px] h-[39.2px] rounded-full hover:bg-[#eaeaea] flex items-center
             justify-center">
                 ...
                 text-[15px] font-normal font-roboto">
                    ...
                    <div v-if="videoOptionStates[short.id]?.editDiv" class="edit-title-description bg-white z-40 w-[488px] h-[368px] rounded-lg
                 flex flex-col justify-start pt-2 items-center gap-y-4 absolute left-2 top-6">
                     ...
                     gap-x-2 pr-2 pb-2">
                            ...
                            <button @click="toggleVideoEdit(short.id)" class="w-[74.9px] h-[36px] rounded-3xl text-[14px] font-medium
