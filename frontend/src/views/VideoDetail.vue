...
<template>
    <div class="main-container flex flex-row w-full h-full relative top-14 left-12 mt-4">
            ...
            <div v-if="!youtubeVideoLink" @mouseover="handleControlBar('open')" @mouseleave="handleControlBar('close')"
                ...
                <div v-if="showAnnotation" :style="{ bottom: isControlBarVisible ? '64px' : '8px' }" class="annotation-div absolute right-3 w-10
                    ...
                    <img @mouseenter="showAnnotationButton" @mouseleave="hideAnnotationButton"
                        class="annotation-img w-full h-full cursor-pointer" :src="videoInfo.channel_watermark_url"
                        alt="">
                    ...
                    justify-center text-white">
                        <span class="text-[11px] font-normal text-left self-start ml-3 mb-1">{{ videoInfo.channel_name
                            }}</span>
                ...
                <div class="control-bar bg-transparent z-50 flex opacity-0 w-full h-[48px] max-h-[48px] absolute bottom-0 justify-center
                    ...
                    <div class="video-progress-bar w-[98%] h-[8px] absolute bottom-14">
                        ...
                        <input :disabled="isAdPlaying" @mousemove="getVideoFrame"
                            ...
                            min="0" max="100" :value="videoProgress" id="progress-bar" class="h-full w-full"
                    ...
                    items-center gap-x-6 pl-3">
                        ...
                        <button class="flex flex-row justify-center items-center">
                            ...
                            <input @input="videoVolumeChanging" value="50" id="volume-bar"
                                class="w-[52px] h-[48px] ml-2 hidden" type="range">
                        </button>
        ...
        <div class="right-side-container flex flex-col ml-[20px] w-[29.5%] max-w-[426px] h-auto">
            ...
            <div class="related-videos flex flex-col absolute max-w-[426px]" :style="relatedVideosStyle">
                <div class="related-video">
                    <div class="related-video-thumbnail">
                        <img src="@/assets/img/Django.png" alt="">
                    </div>
