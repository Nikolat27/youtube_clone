...
<template>
    <aside class="side-bar-div bg-white z-[100]" style="top: 0px; left: 0px; padding-left: 10px; height: 100%;">
        <div class="flex flex-row items-center">
            <button @click="closeSideBar" class="w-[50px] shrink-0 h-[50px] bg-white hover:bg-[#f1f1f1] flex
             justify-center items-center rounded-full mr-4">
                <img @click="toggleWebsiteSideBar" class="shrink-0" src="@/assets/icons/header/hamburger-menu.svg"
                    alt="">
            </button>
            <img class="youtube-logo-img min-w-[108px] w-[108px]" src="@/assets/icons/header/youtube-logo.svg" alt="">
        </div>
        <router-link to="/">
