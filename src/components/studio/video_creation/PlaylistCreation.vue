...
const playlistVisibility = ref('public') // Only public or private is acceptable
     ...
     w-[576px] h-[555px] rounded-xl flex flex-col" style="z-index: 999 !important;">
        ...
        <div class="flex flex-col justify-start items-center mt-6">
            ...
            <div class="playlist-footer w-full h-[68px] flex justify-end items-center pr-8
                ...
                <button :disabled="!userAbleToSave" :class="[!userAbleToSave ? 'opacity-80' : '']" class="w-[73px] h-[36px] rounded-3xl bg-black text-white text-[14px]
